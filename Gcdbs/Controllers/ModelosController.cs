...
namespace Gcdbs.Controllers
{
    public class ModelosController : Controller
    {
        ...
        public ModelosController(GcDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdModelo,NomeModelo")] Modelo modelo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdModelo,NomeModelo")] Modelo modelo)
        {
